...
class Train extends My_Controller {
	...
	public function index($page = 1) {
		...
		$realname && $where_str .= " AND d.realname like '%{$realname}%'";
		
		if($this->_user['role_id'] == '2'){
			//分店管理员
			$where_str .= " AND c.store_id = {$this->_user['store_id']}";
		...
		$sql_arr ['data_sql'] = "SELECT a.*,b.course_name,c.coach_name,d.realname,d.nickname FROM w_order a LEFT JOIN w_course b ON a.course_id = b.course_id
