...
<div id="main-content">
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="box">
                <div class="box-title">
                    <h3><i class="icon-table"></i> 分店管理</h3>

                    <div class="btn-toolbar pull-right clearfix">
                        <div class="btn-group">
                            <a class="btn btn-circle show-tooltip" title="增加分店"
                            ...
                            <td>
                                <div class="btn-group">
                                    <a class="btn btn-small show-tooltip" title="Edit"
                                       href="<?php echo base_url() ; ?>shop/store/detail/<?php echo $this->_vars->value['store_id'] ; ?>"><i
                                            class="icon-edit"></i></a>
                                </div>
                            </td>
                        </tr>
